  ...
  return (
    ...
    <div className="headerContainerInner">
      ...
      <div className="headerRight">
        <button className="landingPLoginBtn" onClick={() => Nav("/login")}> Log In </button>
        <button className="signupBtn" onClick={() => Nav("/Signup")}> Get Started </button>
      </div>
    </div>
  </div>
  )
